...
describe('retrieve users', () => {
    ...
    it('should succeed on correct credentials', async () => {
        ...
        expect(_users.name).toBe(name)
        expect(_users.surname).toBe(surname)
        expect(_users.idCard).toBe(idCard)
        expect(_users.phone).toBe(phone)
        expect(_users.adress).toBe(adress)
        expect(_users.city).toBe(city)
        expect(_users.email).toBe(email)
    })
    }),
    // it('should succeed on correct credentials', async () => {
