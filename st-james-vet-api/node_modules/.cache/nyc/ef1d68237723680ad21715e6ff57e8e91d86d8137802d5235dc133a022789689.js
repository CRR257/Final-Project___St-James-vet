...
describe('retrieve pets', () => {
    ...
    it('should succeed on correct credentials', async () => {
        const pet = await logic.retrievePets()
...
false && describe('updateUser', () => {
    ...
    it('should succeed updating an user', async () => {
  
        const user = await logic.assignAppointment(owner._id.toString(), pet._id.toString(), date)
        expect(appointment.owner).toBeDefined()
        expect(appointment.pet).toBeDefined()
        expect(appointment.date).toBeDefined()
    })
